        ...
        <div class="row">
          <div class="col-11">
            ...
            <q-card flat bordered class="my-card">
              <q-card-section>
                <div class="text-h6">Historial MENUS</div>
              </q-card-section>
