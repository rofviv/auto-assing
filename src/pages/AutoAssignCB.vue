<template>
  <q-page class="q-pa-md">
    <div class="text-center text-h6">COCHABAMBA</div>
        ...
        <div class="row">
          <div class="col-11">
            ...
            <q-card flat bordered class="my-card">
              <q-card-section>
                <div class="text-h6">Historial MENUS y ACCEPT CB</div>
              </q-card-section>
      ...
      <div class="col-6">
        ...
        <div class="row">
          <div class="col-11">
            ...
            <q-card flat bordered class="my-card">
              <q-card-section>
                <div class="text-h6">Historial DELIVERY CB</div>
              </q-card-section>
